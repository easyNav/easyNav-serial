...
class Alert(object):
    ...
    def performObstacleAvoidance(self):
        ...
        while (hasObstacle) :
            ...
            if (currentObstacle == Alert.OBSTACLE_LEFT):
                ...
                voiceAlert = Alert.VOICE_ALERT_OBSTACLE_RIGHT 
            elif (currentObstacle == Alert.OBSTACLE_BOTH):
                voiceAlert = Alert.VOICE_ALERT_STOP 
            else:
                hasObstacle = False
    ...
    def sonardata(self, args):
        payload =eval(args.get("payload"))
        #payload = args
        self.sonarLeft = payload['1']
        self.sonarRight = payload['2']
        #print "alert : sonar data received\n"
